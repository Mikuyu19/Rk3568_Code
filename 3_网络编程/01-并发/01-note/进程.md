...
![image-20260417140911594](进程.assets/image-20260417140911594.png)
...
-   系统的每一个程序都会运行在某一个进程的上下文中
    ...
    <img src="进程.assets/1776390139166.png" alt="1776390139166" style="zoom:50%;" />

-   进程的特点

    1.进程是一个独立的可调度的活动，由操作系统进行统一的管理，相应的任务就会被cpu调度

    <img src="进程.assets/1776390298836.png" alt="1776390298836" style="zoom:50%;" />

    2.进程一旦产生，则需要分配相关的资源，同时进程是分配资源的最小单位

    <img src="进程.assets/1776390795556.png" alt="1776390795556" style="zoom:50%;" />
...
<img src="进程.assets/1776391646268.png" alt="1776391646268" style="zoom:50%;" />
...
<img src="进程.assets/1776392263542.png" alt="1776392263542" style="zoom:50%;" />

-   一旦进程创建好后，系统则要为这个进程分配相应的资源，一般系统会每个进程分配4G的地址(32位系统)

-   4G地址空间结构

    <img src="进程.assets/1776393238815.png" alt="1776393238815" style="zoom:50%;" />
...
-   会为进程分配4G的虚拟地址空间
    ...
    <img src="进程.assets/image-20260417110618016.png" alt="image-20260417110618016" style="zoom:50%;" />
...
-   虚拟地址通过映射的方式建立物理地址的关系，从而达到访问虚拟地址就可以访问到对应的物理地址
    ...
    ![image-20260417111413174](进程.assets/image-20260417111413174.png)
...
![image-20260417173932299](进程.assets/image-20260417173932299.png)
...
第一轮fork出俩个进程但由于在缓冲区所以不打印  两个进程各自带有一个_缓冲区中
第二轮fork出来四个进程 四个缓冲区里都有一个_
接下来四个进程都又塞进去printf里面的_变成四个缓冲区里面每个都有两条_
最后return flush出所有缓冲区的数据变成八个_
